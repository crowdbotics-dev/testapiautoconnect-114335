...
## Project Structure
    ...
    ├── testapiautoconnect_114335  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_114335`
...
2. Clone this repo and `cd testapiautoconnect_114335`
